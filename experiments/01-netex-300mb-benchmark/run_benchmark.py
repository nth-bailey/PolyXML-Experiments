"""Comparative benchmark between PolyXML native engine and standard pure-Python XmlParser on NeTEx datasets."""
...
def parse_args():
    ...
    parser.add_argument(
        "--skip-standard",
        action="store_true",
        help="Skip the standard pure-Python parser benchmark (which can take >90s)",
    )
...
def main():
    ...
    from pyxsdata.formats.dataclass.parsers import CoreXmlParser, XmlParser

    file_size_mb = args.xml.stat().st_size / (1024 * 1024)

    # 1. Benchmark PolyXML Native Engine
    print("==================================================")
    print("  BENCHMARK: PolyXML Native Engine (CoreXmlParser)")
    ...
    print("\n==================================================")
    print("  BENCHMARK: Default pyxsdata XmlParser (Pure Python)")
    ...
    std_parser = XmlParser()
    print("Executing standard parser (this typically takes ~90+ seconds)...")
    ...
    speedup = t_std / t_poly
    ram_reduction = (1.0 - (rss_after_poly / rss_after_std)) * 100
    print("\n==================================================")
    print(f"🚀 SUMMARY: PolyXML is {speedup:.1f}x FASTER!")
    print(f"🚀 MEMORY:  PolyXML uses {ram_reduction:.1f}% LESS peak RAM!")
    print("==================================================")
